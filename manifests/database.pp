...
define postgresql::database(
  ...
  # Optionally set the database owner
  $owner_option = $owner ? {
    undef   => '',
    default => "-O ${owner}"
  }

  $createdb_command_tmp = "${postgresql::params::createdb_path} --template=template0 --encoding '${charset}' ${locale_option} '${dbname}' ${owner_option}"
